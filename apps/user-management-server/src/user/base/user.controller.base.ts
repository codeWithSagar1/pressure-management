...
export class UserControllerBase {
  ...
  async createUser(@common.Body() data: UserCreateInput): Promise<User> {
    return await this.service.createUser({
      ...
      select: {
        autoLogoutTime: true,
        autoLogoutTimeCustom: true,
        autoUnblockTime: true,
        autoUnblockTimeCustom: true,
        comment: true,
        commentCustom: true,
        createdAt: true,
        email: true,
        expiryDaysNotification: true,
        expiryDaysNotificationCustom: true,
        firstName: true,
        id: true,
        lastName: true,
        numberOfAttempts: true,
        numberOfAttemptsCustom: true,
        passwordExpiry: true,
        passwordExpiryCustom: true,
        passwordText: true,
        roles: true,
        updatedAt: true,
        userLevel: true,
        userLevelCustomized: true,
        username: true,
        userName: true,
        usernameCustom: true,
      },
